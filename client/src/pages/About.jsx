          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              >
                ...
                and families affected by addiction, providing compassionate care
                in a tranquil healing environment.
              </motion.p>
            </div>
          </div>
        </ScrollAnimation>
              ...
              <div>
                <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-100 hover:shadow-xl transition-all duration-300">
                  ...
                  <p className="text-lg text-gray-700 leading-relaxed mb-6">
                    ...
                    rebuild fulfilling, purposeful lives. We believe that
                    everyone deserves the opportunity to heal, grow, and thrive.
                  </p>
              ...
              <div>
                <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-100 hover:shadow-xl transition-all duration-300">
                  ...
                  <p className="text-lg text-gray-700 leading-relaxed mb-6">
                    ...
                    unwavering commitment to transforming lives and
                    ...
                    <StaggerItem>
                      <div className="flex items-start transform hover:translate-x-2 transition-transform duration-300">
                        ...
                        <div>
                          ...
                          <p className="text-gray-600">
                            Evidence-based treatments with demonstrated success
                            rates
                          </p>
                        </div>
                      </div>
